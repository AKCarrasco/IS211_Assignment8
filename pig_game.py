#Aaron Carrasco Assignment 8
import time
import random

#Die class for dice roll simulation
class Die:
    def roll(self):
...
class ComputerPlayer(Player):
    ...
    def make_move(self):
        #Hold at 25 points or less if close to winning
        ...
        def play_game(self):
            while True:
                if self.check_time():
                    ...
                    if p1.turn_score > p2.turn_score:
                        winner = p1
...
if __name__ == '__main__':
    ...
    #TimedGateProxy if the timed argument is passed
